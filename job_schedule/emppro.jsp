...
String q="insert into employee(employee_id,employee_name,employee_email,employee_phno) values(?,?,?,?)";  
...
out.println("<script>alert('employee added sucessfully');window.location.href='home.jsp';</script>");  
