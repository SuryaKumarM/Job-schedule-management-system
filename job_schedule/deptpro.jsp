...
String q="insert into department(department_id,department_name,manager_name,location_id) values(?,?,?,?)";  
...
out.println("<script>alert('new department added sucessfully');window.location.href='home.jsp';</script>");  
